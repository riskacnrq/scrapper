...
for (let i of bc) {
sock.sendMessage(i.id, { text: `*[ Babybot BROADCAST ]*\n\n${q}` })
}
break
case 'couple': {
if (q.includes('--help')) return reply(examkosong) 
  ...
  case 'menu2':{  
   let button = [{
     index: 1, 
      urlButton: {
       displayText: 'ada bug?', 
       url: 'https://github.com/6288227606701'
       } 
     },     
     {
     index: 2, 
